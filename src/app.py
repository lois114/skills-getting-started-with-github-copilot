...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps and work on technique in the pool",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "sophia2@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for debate tournaments and improve public speaking",
        "schedule": "Tuesdays, 5:00 PM - 6:30 PM",
        "max_participants": 14,
        "participants": ["emma2@mergington.edu", "owen@mergington.edu"]
    }
}
