          ...
          ? `<div class="participants">
              ...
              <ul class="participants-list">
                ${details.participants
                  .map(
                    (participant) =>
                      `<li><span>${participant}</span><button type="button" class="delete-participant" data-participant="${participant}" aria-label="Remove ${participant}">×</button></li>`
                  )
                  .join("")}
              </ul>
            </div>`
          : `<div class="participants no-participants"><strong>Participants:</strong> None yet.</div>`;
